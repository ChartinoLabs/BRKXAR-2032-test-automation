...
def handle_test_execution_mode(
    ...
    current_state_callable: Callable[[TestbedAdapter], dict],
    comparison_callable: Callable[[dict, ParameterData, TestbedAdapter], None],
    mode: RunningMode,
    parameters_file: str,
    ...
    current_state = current_state_callable(testbed_adapter)
    ...
    # TESTING MODE: Verify against parameters file
        ...
        try:
            comparison_callable(current_state, expected_parameters, testbed_adapter)
            result_msg = (
